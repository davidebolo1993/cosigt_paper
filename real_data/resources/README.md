...
- [5](GRCh38.alts_to_primary.paf.gz*). `GRCh38.alts_to_primary.paf.gz*`. Bgzip-compressed alignment of GRCh38 alternative sequences to the primary chromosomes (and their index) - generated with `minimap2 -x asm20 --eqx -c` and used within `impg` to identify intervals in alternative sequences that may have captured reads in the primary chromosomes. 
